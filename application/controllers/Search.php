	...
	class Search extends CI_Controller {
		...
		public function index($page = 'search') {
			if(!file_exists(APPPATH.'views/pages/'.$page.'.php')) {
				...
				$data['meta_keyword'] = "Find a ".the_config('site_name').", 247 ".the_config('site_name')." services, ".the_config('site_name')." experts, commercial ".the_config('site_name').", residential ".the_config('site_name').", car ".the_config('site_name').", automotive ".the_config('site_name')." experts, lockout services, emergency ".the_config('site_name').", 24 hour ".the_config('site_name')."";
				$data['meta_description'] = the_config('site_name')." allows you to find the nearest ".the_config('site_name')." near your area. Be it a commercial, residential or a car ".the_config('site_name')." expert, you can find them here.";
				...
				if(!empty($data['location']) AND isset($data['location'])) {
					...
					if($search_proper != 0) {
						...
						redirect(base_url('city/'.$data['search_data']->slug));
