<section class="city-content">
	<section class="section-header data-img" data-bg="<?php echo base_url('build/images/states/'.strtoupper($city_data->state).'.jpg'); ?>">
		<div class="overlay">
			<div class="container">
				<h1 class="">
					If you need a 24 Hour Locksmith in <span class="location-inblock"><?php echo $city_data->name.', '.strtoupper($city_data->state); ?></span>
				</h1>
				<br/>
				<h4 class=""><span class="location-inblock"><?php echo $city_data->name.', '.strtoupper($city_data->state); ?></span> <a href="tel:<?php echo $city_data->phone; ?>" class="phone-inblock">Call <?php echo $city_data->phone; ?></a></h4>
			</div>
		</div>
	</section>
    		...
    		<div class="row">
    			...
    			<div class="col-md-4">
    				<div class="aside">
    					...
    					<hr/>
    					<?php include('parts/widget-aside-zip-area.php'); ?>
    					<hr/>
